 ...
 * oversettingsenhet. Inkluderingsrekkefolgen betyr noe: en senere #include
 * med #undef overskriver en tidligere #define.
 */

#include <WiFi.h>
#include <WiFiClientSecure.h>
#include "config.h"
#include "config_local.h"   // inkludert ETTER config.h — se merknad over
#include "modbus.h"
